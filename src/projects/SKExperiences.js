...
class SKExperiences extends Component {
  state = {
    logoImage: img00
  }
          ...
          <div className="summary-container">
            <div className="summary-container-left">
              ...
              <div className="content end white">
                ...
                I redesigned the core layout of the app to scale for future implementations. 
                Throughout the process, I was careful to balance the usability, business, and technical goals. 
                The layout was proved easy to use by multiple users in an interview conducted shortly after the release.
              </div>
            </div>
